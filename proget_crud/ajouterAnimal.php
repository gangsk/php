...
<form action="./php/createAnimal.php"
method="post">
            ...
            <div class="mb-3">
                ...
                <select class="form-select" aria-label="Default select example" id="categories" name="libelle_espece">
                ...
                <select class="form-select" aria-label="Default select example" id="categories" name="nom_enclos">
