...
<h1>Ajouter Enclos </h1>
    
    <form action="./php/createEnclos.php" method="post">

        <div class="form-group">
            <input type="text" name="nomEnclos" class="form-control is-invalid" >
        ...
        <button class="btn btn-success" name="valideEnclos">Valide</button>
